...
latex_documents = [
  ('index', 'fuel-plugin-dynatrace-qa-report.tex', u'Dynatrace plugin for Fuel Test Report',
...
texinfo_documents = [
  ('index', 'Dynatrace', u'Dynatrace Plugin for Fuel Test Report',
   u'Dynatrace LLC.', 'Dynatrace', 'Dynatrace Plugin for Fuel Test Report',
   'Miscellaneous'),
]
